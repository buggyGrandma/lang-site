    ...
    <footer className='w-full relative '>
        ...
        <div className='flex px-[6.5rem] lg-max:px-8 py-16 bg-white w-full justify-start gap-x-8 lg-max:flex-col'>
            <div className='w-[45%] lg-max:w-full'>
                <h2 className='text-[#444] font-iranSans font-medium text-base leading-8 mb-5 lg-max:text-sm lg-max:leading-7'>همه روزه ( بجز روزهای تعطیل ) از 8 صبح تا ساعت 12 شب پاسخگو هستیم.</h2>
