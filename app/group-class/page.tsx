  ...
  return (
    <main className="bg-[#F8F8FB]">
      ...
      <section className="w-full h-[40rem] bg-[#212121]">
        <h1 className="font-iranSansBold font-bold text-[2rem] text-[#1FD998] text-center leading-relaxed mb-4 pt-24">
          {" "}
          ثبت نام کلاس های گروهی زبان{" "}
          <span className="bg-[#2E2E2E] text-white p-1">آنلاین </span>
        </h1>
        <h2 className="font-iranSans text-[#B7B7B7] text-xl text-center font-medium">
        ...
        <button className="w-[175px] h-[52px] bg-red-600 flex justify-center items-center mx-auto mt-8 ">
          replace me!
        </button>
        <Image
          src={vTemp}
      ...
      <div className=" w-full relative z-10 ">
        <div className="bg-[#f8f8fb]  mt-[-10rem] absolute w-[85%] mx-[6.5rem] z-0 h-[700px] rounded-lg"></div>
        <section className="flex flex-col space-y-4 pt-16">
          <h2 className="text-center font-roboto text-[#8A8A8A45] uppercase fill-white stroke-[#8a8a8a45] tracking-[2.72px] text-[2rem] font-black leading-[3.5rem] z-50">
            courses
          </h2>
